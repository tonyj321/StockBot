 ...
 * @author arujohn
 */
public class EMABuySellStrategy {
    ...
    EMABuySellStrategy(Map<String, Stock> stockMap, StockDate start, StockDate end) {
        ...
        for (String ticker : stockMap.keySet()) {
            ...
            try {
                ...
                for (StockDate day : StockDate.range(start, end)) {
                    ...
                    final double currentValue = ema.valueAt(day) - stock.closingPrices().valueAt(day);
